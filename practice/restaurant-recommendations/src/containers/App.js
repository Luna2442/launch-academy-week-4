...
class App extends Component {
  constructor(props) {
    ...
    this.handleSubmitRestaurant = this.handleSubmitRestaurant.bind(this)
  }
  ...
  handleSubmitRestaurant(restaurant){
    ...
    return(
      <div>
        <div className="row">
          ...
          <div className="small-9 columns">
            <h2>Review Form</h2>
            <ReviewForm id={this.state.selectedId}  submitFunction={this.handleSubmitReview}/>
          </div>

          <div className="small-9 columns">
            <h2>Add Restaurant</h2>
            <RestaurantForm submitFunction={this.handleSubmitRestaurant}/>
          </div>
